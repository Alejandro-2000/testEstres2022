...
<div class="modal fade" id="modal_agregar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form method="POST" action="{{ route('sexo.store') }}"  role="form" enctype="multipart/form-data">
                    ...
                    <div class="box box-info padding-1">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="descripcion_sexo" class="form-control{{$errors->has('descripcion_sexo') ? ' is-invalid' : ''}}" placeholder="Descripcion">
