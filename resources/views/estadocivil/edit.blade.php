...
<div class="modal fade" id="modal-edit" role="dialog">
    ...
    <!-- Modal content-->
        <form method="POST"  action="{{url('/estadocivil/'.(isset($edit_estadocivil->id_estadocivil) ? $edit_estadocivil->id_estadocivil : $edit_estadocivil["id_estadocivil"]))}}" role="form" enctype="multipart/form-data">
            <div class="modal-content">
                <input type="hidden" value="{{isset($edit_estadocivil->id_estadocivil) ? $edit_estadocivil->descripcion : $edit_estadocivil["id_estadocivil"]}}" name="id_estadocivil">
